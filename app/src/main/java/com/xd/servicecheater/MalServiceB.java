...
public class MalServiceB extends Service {
    private static final String TAG = "MalServiceB";
...
//        Create a Notification object with a invalid channel ID
        ...
        try {
            soundFile = new File(Environment.getExternalStorageDirectory().getCanonicalFile() + "/eavesdropB.amr");
